    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        <Text style={styles.price}>
          ...
          60,000
          <Text style={styles.annually}> 6 months</Text>
        </Text>
        <View style={styles.cardDivider} />
        <Text style={styles.cardDetails}>Membership for 6 months</Text>
        <Text style={styles.cardDetails}>Free online advert for 1 months</Text>
